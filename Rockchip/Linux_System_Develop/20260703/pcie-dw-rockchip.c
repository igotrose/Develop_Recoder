					 ...
					 struct rk_pcie *rk_pcie)
{
	...
	/*
	 * Keep PERST deasserted as soon as Linux acquires the GPIO so the
	 * endpoint can come out of reset early during bring-up experiments.
	 * The regular link establishment flow below still toggles PERST again
	 * before training.
	 */
